...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rmii_tx_agile is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rmii_tx_agile;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rmii_tx_agile is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_fifo_disposer is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_fifo_disposer;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_fifo_disposer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_fifo_loader is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_fifo_loader;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_fifo_loader is
...
I_SRL_FIFO: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SRL_FIFO
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rmii_rx_agile is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rmii_rx_agile;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rmii_rx_agile is
...
begin
  SR(0) <= \^sr\(0);
I_RX_FIFO: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_fifo
     port map (
...
I_RX_FIFO_DISPOSER: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_fifo_disposer
     port map (
...
I_RX_FIFO_LOADER: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rx_fifo_loader
     port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mii_to_rmii is
  ...
  attribute C_FAMILY of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mii_to_rmii : entity is "zynq";
  attribute C_FIXED_SPEED : string;
  attribute C_FIXED_SPEED of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mii_to_rmii : entity is "1'b0";
  ...
  attribute C_SPEED_100 of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mii_to_rmii : entity is "1'b0";
...
begin
\RMII_AGILE.I_RX\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rmii_rx_agile
     port map (
...
\RMII_AGILE.I_TX\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_rmii_tx_agile
     port map (
