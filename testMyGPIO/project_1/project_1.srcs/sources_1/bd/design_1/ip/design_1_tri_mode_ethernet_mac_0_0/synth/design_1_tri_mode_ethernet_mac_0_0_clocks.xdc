...
set_false_path -from [get_cells {design_1_tri_mode_ethernet_mac_0_0_core/*managen/conf/int_*reg[*]}] -to $ip_gtx_clk
set_false_path -from [get_cells {design_1_tri_mode_ethernet_mac_0_0_core/*managen/conf/int_*reg[*]}] -to $ip_mii_tx_clk
set_false_path -from [get_cells {design_1_tri_mode_ethernet_mac_0_0_core/*managen/conf/int_*reg[*]}] -to $rx_clk
set_false_path -from [get_cells {design_1_tri_mode_ethernet_mac_0_0_core/*managen/conf/int_*reg}] -to $ip_gtx_clk
set_false_path -from [get_cells {design_1_tri_mode_ethernet_mac_0_0_core/*managen/conf/int_*reg}] -to $ip_mii_tx_clk
set_false_path -from [get_cells {design_1_tri_mode_ethernet_mac_0_0_core/*managen/conf/int_*reg}] -to $rx_clk
