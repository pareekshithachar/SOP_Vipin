...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set phy_reset_n [ create_bd_port -dir O -from 0 -to 0 phy_reset_n ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins tri_mode_ethernet_mac_0/s_axis_tx]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins tri_mode_ethernet_mac_0/s_axi]
  ...
  connect_bd_intf_net -intf_net tri_mode_ethernet_mac_0_m_axis_rx [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins tri_mode_ethernet_mac_0/m_axis_rx]
connect_bd_intf_net -intf_net [get_bd_intf_nets tri_mode_ethernet_mac_0_m_axis_rx] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets tri_mode_ethernet_mac_0_m_axis_rx]
  connect_bd_intf_net -intf_net tri_mode_ethernet_mac_0_mdio_external [get_bd_intf_ports mdio_external_0] [get_bd_intf_pins tri_mode_ethernet_mac_0/mdio_external]
  connect_bd_intf_net -intf_net tri_mode_ethernet_mac_0_mii [get_bd_intf_pins mii_to_rmii_0/MII] [get_bd_intf_pins tri_mode_ethernet_mac_0/mii]

  # Create port connections
  connect_bd_net -net M01_ACLK_1 [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins tri_mode_ethernet_mac_0/s_axi_aclk]
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins mii_to_rmii_0/ref_clk] [get_bd_pins tri_mode_ethernet_mac_0/gtx_clk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_ports phy_reset_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins mii_to_rmii_0/rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins tri_mode_ethernet_mac_0/glbl_rstn] [get_bd_pins tri_mode_ethernet_mac_0/rx_axi_rstn] [get_bd_pins tri_mode_ethernet_mac_0/s_axi_resetn] [get_bd_pins tri_mode_ethernet_mac_0/tx_axi_rstn]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins proc_sys_reset_2/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  ...
  connect_bd_net -net tri_mode_ethernet_mac_0_rx_mac_aclk [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins tri_mode_ethernet_mac_0/rx_mac_aclk]
  connect_bd_net -net tri_mode_ethernet_mac_0_tx_mac_aclk [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins tri_mode_ethernet_mac_0/tx_mac_aclk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs tri_mode_ethernet_mac_0/s_axi/Reg] SEG_tri_mode_ethernet_mac_0_Reg
